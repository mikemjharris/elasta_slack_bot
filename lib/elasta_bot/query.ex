defmodule ElastaBot.Query do
    ...
    def create_body_for_es_post_request(nos_queries \\ 10) do
        ...
        create_request(start_time, end_time, query, nos_queries) 
        |> convert_to_json()
        |> to_string
    end
